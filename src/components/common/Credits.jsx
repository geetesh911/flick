            ...
            <div className="col-10 items">
              ...
              {singleTitle.cast &&
                singleTitle.cast.cast.map((credit) => (
                  <div className="card item" key={credit.id}>
                    <img
                      src={
                        credit.profile_path ||
                    ...
                    <div className="card-body">
                      <h5 className="card-title tooltip-test">
                        {" "}
                        <Link
                          to="#!"
                          onClick={() => handleShow(credit.id)}
                          title={credit.name}
                          className="tooptip-test"
                        >
                          {credit.name}
                        </Link>
                      </h5>
                      <p
                        className="card-text tooltip-test"
